...
# 변수 초기화
{
  ...
  "대응방안": {
    "설명": "API Server는 Kubernetes의 중심이며, 올바른 인증 구현이 필수적입니다. 서비스 계정과 사용자 계정을 통한 인증 관리, 안전한 인증 방식 사용, 비인증 서비스 접근 차단 등을 통해 API Server의 보안을 강화합니다.",
    "설정방법": [
      "외부 인증 서비스를 사용하여 사용자 계정 관리",
      "비인증 접근 차단을 위해 kube-apiserver.yaml 설정 수정",
      "취약한 인증 방식 사용 금지",
      "서비스 API의 외부 노출 금지",
      "OAuth나 Webhook과 같은 계정 연동 서비스 활용"
    ]
  },
  "현황": [],
  "진단_결과": ""
